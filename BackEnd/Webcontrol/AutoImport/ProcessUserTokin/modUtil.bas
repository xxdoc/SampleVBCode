...
Public gARV As V2ARViewer.clsARViewer
...
EH:
    ...
    Close #iFFile
    Err.Raise lErrNum, , "Public Sub SaveFileData" & vbCrLf & vbCrLf & sErrDesc & vbCrLf & psFilePath
End Sub
...
Public Sub ShowError(pobjErr As ErrObject, psProc As String, Optional pFormOwner As Form, Optional psMod As String)
    ...
    goUtil.utShowError App.EXEName, pobjErr, psProc, pFormOwner, psMod, lErrNum, sErrDescription
    
    If Not pFormOwner Is Nothing And psMod = vbNullString Then
        sErrMess = "ClassName: " & pFormOwner.Name & vbCrLf
    Else
        sErrMess = "ClassName: " & psMod & vbCrLf
    End If
    sErrMess = sErrMess & "ProcName: " & psProc & vbCrLf
    sErrMess = sErrMess & "ERROR # " & lErrNum & vbCrLf
    sErrMess = sErrMess & sErrDescription & vbCrLf & vbCrLf
    ErrorLog sErrMess
