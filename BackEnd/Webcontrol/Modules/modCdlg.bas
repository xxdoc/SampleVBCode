...
Public Function ShowOpen(ByVal hWnd As Long, Optional ByVal centerForm As Boolean = True) As SelectedFile
    ...
    Exit Function
EH:
    'ShowError Err, "Public Function ShowOpen", , "modCdlg.bas"
    Err.Clear
    Resume Next
End Function
...
Public Function GetPath(psName As String, psMess, psFileMess, psDeFaultPath As String, plHwnd As Long, _
                         Optional psFilter As String = vbNullString, _
                         Optional psSelFile As String, _
                         Optional plFlags As Long) As String
    On Error GoTo EH
    ...
    Else
        sInitDir = GetSetting(App.EXEName, "Dir", psName, "Error")
    End If
    ...
    If Err.Number <> 32755 And sOpen.bCanceled = False Then
        ...
        psSelFile = sOpen.sFiles(1)
        SaveSetting App.EXEName, "Dir", psName, sDir
        GetPath = sDir
    Else
   ...
   Exit Function
EH:
    ShowError Err, "Public Function GetPath", , "modCdlg.bas"
End Function

Public Sub CleanFileName(pvText As Variant, Optional pbFilePath As Boolean)
    On Error GoTo EH
    Dim lPos As Long
    Dim sTemp As String
    ...
    If IsObject(pvText) Then
        If TypeOf pvText Is TextBox Then
    ...
    Exit Sub
EH:
    ShowError Err, "Public Sub CleanInvalidFileNameChar", , "modCdlg.bas"
End Sub
