VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} arRptIBTWIA 
   Caption         =   "IB"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arRptIBTWIA.dsx":0000
End
Attribute VB_Name = "arRptIBTWIA"
...
Private Sub ActiveReport_ReportStart()
    ...
    If GetProperty("f01_sSubToCarrier") = vbNullString Then
        f01SubmitTo.Text = "TWIA Insurance Company"
    Else
