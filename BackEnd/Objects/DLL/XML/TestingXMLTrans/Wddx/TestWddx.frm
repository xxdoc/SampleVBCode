...
Public Function GetXMLLoss(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As String
    ...
    'Primary Address
    Dim oAddressRS As WDDXRecordset
    ...
    'Contacts
    Set oContactsRS = GetContactsRS(oLossReport)
    'Primary Address
    Set oAddressRS = GetAddressRS(oLossReport)
    'Policy Unit
    ...
    End If
    'Set the Contacts
    If Not oContactsRS Is Nothing Then
        oMyStruct.setProp "ContactsRS", oContactsRS
    End If
    'Set the Primary Address
    If Not oAddressRS Is Nothing Then
        oMyStruct.setProp "AddressRS", oAddressRS
    End If
...
Public Function GetAssignmentDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetAssignmentDetailRS.addColumn "UniqueId"
    GetAssignmentDetailRS.addColumn "UnitNumber"
    GetAssignmentDetailRS.addColumn "ClaimNumber"
    GetAssignmentDetailRS.addColumn "DateAssigned"
    ...
    If mlMyUniqueID = 0 Then
        mlMyUniqueID = 123
    Else
        mlMyUniqueID = mlMyUniqueID + 1
    End If
    
    
    With MyudtXML01AssignmentDetail
        vValue = CStr(mlMyUniqueID) & "-1-1"
        GetAssignmentDetailRS.setField 1, "UniqueId", vValue
        vValue = CStr(mlMyUniqueID) & "-1"
        GetAssignmentDetailRS.setField 1, "UnitNumber", vValue
        vValue = CStr(mlMyUniqueID)
        GetAssignmentDetailRS.setField 1, "ClaimNumber", vValue
        vValue = .cli04_DateAsgn
        GetAssignmentDetailRS.setField 1, "DateAssigned", vValue
        vValue = .cli01_CAT
...
Public Function GetContactDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetContactDetailRS.addColumn "UniqueId"
    ...
    With MyudtContactDetail
        vValue = CStr(mlMyUniqueID) & "-1-1"
        GetContactDetailRS.setField 1, "UniqueId", vValue
...
Public Function GetContactsRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    Dim MyXML01LossReport As XMLTypes.XML01LossReport
    Dim MyudtXML01Loss As XMLTypes.udtXML01Loss
    Dim MyudtContacts As XMLTypes.udtContacts
    Dim vValue As Variant 'Use Variant to Get Variant Equiv Data Type.
    
    MyXML01LossReport = oLossReport.LossReport
    MyudtXML01Loss = MyXML01LossReport.XML01Loss
        
    Set GetContactsRS = New WDDXRecordset
    
    GetContactsRS.addColumn "ContactRowID"
    GetContactsRS.addColumn "MM"
    GetContactsRS.addColumn "FirstName"
    GetContactsRS.addColumn "LastName"
    GetContactsRS.addColumn "ContactRole"
    GetContactsRS.addColumn "BestPhoneNumber"
    GetContactsRS.addColumn "PrimaryPhoneNumber"
    GetContactsRS.addColumn "HomePhoneNumber"
    GetContactsRS.addColumn "CellularPhoneNumber"
    GetContactsRS.addColumn "FaxPhoneNumber"
    GetContactsRS.addColumn "EmailAddress"
    GetContactsRS.addColumn "PagerPhoneNumber"
    GetContactsRS.addColumn "PagerPIN"
    GetContactsRS.addColumn "WorkPhoneNumber"
    GetContactsRS.addColumn "RelationshipToInsured"
    GetContactsRS.addColumn "PrimaryAddressId"
    GetContactsRS.addColumn "CreatedUpdated"
    
    'Put a couple of  rows for the Data RS
    GetContactsRS.addRows 1
    ...
    With MyudtContacts
        ...
        End If
        .BestPhoneNumber = vbNullString
        .PrimaryPhoneNumber = vbNullString
        .CellularPhoneNumber = vbNullString
        .FaxPhoneNumber = vbNullString
        .EmailAddress = vbNullString
        .PagerPhoneNumber = vbNullString
        .PagerPIN = vbNullString
        .RelationshipToInsured = "Self"
        .PrimaryAddressId = vbNullString
        .CreatedUpdated = Now()
    End With
        
    With MyudtContacts
        vValue = "ContactRowID"
        GetContactsRS.setField 1, "ContactRowID", vValue
        vValue = .MM
        GetContactsRS.setField 1, "MM", vValue
        vValue = .FirstName
        GetContactsRS.setField 1, "FirstName", vValue
        vValue = .LastName
        GetContactsRS.setField 1, "LastName", vValue
        vValue = .ContactRole
        GetContactsRS.setField 1, "ContactRole", vValue
        vValue = .BestPhoneNumber
        GetContactsRS.setField 1, "BestPhoneNumber", vValue
        vValue = .PrimaryPhoneNumber
        GetContactsRS.setField 1, "PrimaryPhoneNumber", vValue
        vValue = .HomePhoneNumber
        GetContactsRS.setField 1, "HomePhoneNumber", vValue
        vValue = .CellularPhoneNumber
        GetContactsRS.setField 1, "CellularPhoneNumber", vValue
        vValue = .FaxPhoneNumber
        GetContactsRS.setField 1, "FaxPhoneNumber", vValue
        vValue = .EmailAddress
        GetContactsRS.setField 1, "EmailAddress", vValue
        vValue = .PagerPhoneNumber
        GetContactsRS.setField 1, "PagerPhoneNumber", vValue
        vValue = .PagerPIN
        GetContactsRS.setField 1, "PagerPIN", vValue
        vValue = .WorkPhoneNumber
        GetContactsRS.setField 1, "WorkPhoneNumber", vValue
        vValue = .RelationshipToInsured
        GetContactsRS.setField 1, "RelationshipToInsured", vValue
        vValue = .PrimaryAddressId
        GetContactsRS.setField 1, "PrimaryAddressId", vValue
        vValue = .CreatedUpdated
        GetContactsRS.setField 1, "CreatedUpdated", vValue
    End With
        
End Function

Public Function GetAddressRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    Dim MyXML01LossReport As XMLTypes.XML01LossReport
    Dim MyudtXML01Loss As XMLTypes.udtXML01Loss
    Dim MyudtAddress As XMLTypes.udtAddress
    Dim vValue As Variant 'Use Variant to Get Variant Equiv Data Type.
    ...
    Set GetAddressRS = New WDDXRecordset
       
    GetAddressRS.addColumn "ContactRowID"
    GetAddressRS.addColumn "AddressId"
    GetAddressRS.addColumn "Type"
    GetAddressRS.addColumn "StreetAddress"
    GetAddressRS.addColumn "StreetAddress2"
    GetAddressRS.addColumn "City"
    GetAddressRS.addColumn "State"
    GetAddressRS.addColumn "PostalCode"
    
    'Put a couple of  rows for the Data RS
    GetAddressRS.addRows 1
    ...
    With MyudtAddress
        ...
        .StreetAddress = sStreet
        .StreetAddress2 = vbNullString
        .City = sCity
        .State = sState
        .PostalCode = sZip
        vValue = "ContactRowID"
        GetAddressRS.setField 1, "ContactRowID", vValue
        vValue = .AddressId
        GetAddressRS.setField 1, "AddressId", vValue
        vValue = .Type
        GetAddressRS.setField 1, "Type", vValue
        vValue = .StreetAddress
        GetAddressRS.setField 1, "StreetAddress", vValue
        vValue = .StreetAddress2
        GetAddressRS.setField 1, "StreetAddress2", vValue
        vValue = .City
        GetAddressRS.setField 1, "City", vValue
        vValue = .State
        GetAddressRS.setField 1, "State", vValue
        vValue = .PostalCode
        GetAddressRS.setField 1, "PostalCode", vValue
    End With
...
Public Function GetCoverageRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetCoverageRS.addColumn "CoverageRowID"
    ...
    If oLossReport.LossType = XML01Pro Then
        ...
        With MyudtCoverage
            ...
            vValue = .CoverageRowID
            GetCoverageRS.setField 1, "CoverageRowID", vValue
            .Coverage = "Building"
...
Public Function GetEndorsementRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetEndorsementRS.addColumn "EndorsementsRowID"
    ...
    For lCount = 1 To MyudtXML01Loss.colEndorsements.Count
        ...
        With MyudtXML01Endorsement
            vValue = "EndorsementsRowID"
            GetEndorsementRS.setField lCount, "EndorsementsRowID", vValue
            vValue = .EDCode
...
Public Function GetPaymentDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetPaymentDetailRS.addColumn "PaymentDetailRowID"
    ...
    With MyXML01LossReport
        vValue = "PaymentDetailRowID"
        GetPaymentDetailRS.setField lCount, "PaymentDetailRowID", vValue
        vValue = "3/6/2005"
        ...
        vValue = "Unit Number this payment belongs to"
    End With
...
Public Function GetPriorLossDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetPriorLossDetailRS.addColumn "PriorLossRowID"
    ...
    For lCount = 1 To MyudtXML01Loss.colPLH.Count
        ...
        With MyudtXML01PriorLossDetail
            vValue = "PriorLossRowID"
            GetPriorLossDetailRS.setField lCount, "PriorLossRowID", vValue
            vValue = .plh01_SALN
...
Public Function GetActivitiesRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    GetActivitiesRS.addColumn "ActivityRowID"
    ...
    For lCount = 1 To MyudtXML01Loss.colCAL.Count
        ...
        With MyudtXML01Activities
            vValue = "ActivityRowID"
            GetActivitiesRS.setField lCount, "ActivityRowID", vValue
...
Public Function GetVehicleDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    'Create a WDDX RS
        ...
        GetVehicleDetailRS.addColumn "UniqueId"
        ...
        vValue = CStr(mlMyUniqueID) & "-1-1"
        GetVehicleDetailRS.setField 1, "UniqueId", vValue
...
Public Function GetLossDetailRS(ByVal oLossReport As V2ECKeyBoard.clsCarLR) As WDDXRecordset
    ...
    'Create a WDDX RS
        ...
        GetLossDetailRS.addColumn "UniqueId"
        ...
        With MyudtXML01AdminLossInfo
            vValue = CStr(mlMyUniqueID) & "-1-1"
            GetLossDetailRS.setField 1, "UniqueId", vValue
            sAddress = .ali0080_LossLocAddress1 & String(2, Chr(32)) & IIf(.ali0081_LossLocAddress2 = vbNullString, vbNullString, S_z & .ali0081_LossLocAddress2)
            goUtil.utFillAddressFields sAddress, sZip, sState, sCity, sStreet
            goUtil.utUpdateAddress sAddress, sZip, sState, sCity, sStreet
