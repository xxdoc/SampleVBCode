VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} arRptIBSafeco 
   Caption         =   "IB"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arRptIBSafeco.dsx":0000
End
Attribute VB_Name = "arRptIBSafeco"
...
Public Property Get ClassName() As String
    ClassName = App.EXEName & "." & "arRptIBSafeco"
End Property
...
Private Sub ActiveReport_ReportStart()
    ...
    With Me
        ...
        .f09aPolicyNumber = GetProperty("f09a_sPolicyNumber")
...
'        .f24ExteriorFee = Format(GetProperty("f24_cExternalDamageBGCharge"), "$##,##0.00")
        cTotalServiceFee = GetProperty("f17_cServiceFee") + GetProperty("f17a_cMiscServiceFee")
