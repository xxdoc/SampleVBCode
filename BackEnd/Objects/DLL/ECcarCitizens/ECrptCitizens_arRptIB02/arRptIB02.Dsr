...
Private Sub ActiveReport_ReportStart()
    ...
    If GetProperty("RemitAddress") = vbNullString Then
        fFirmStreet.Text = "7276 W. Mansfield Avenue"
        sTemp = fFirmStreet.Text & vbCrLf
        fFirmCity.Text = "Lakewood"
        fFirmState.Text = "CO"
        fFirmZip.Text = "80235"
        sTemp = sTemp & fFirmCity.Text & ", " & fFirmState.Text & "  " & fFirmZip.Text & vbCrLf
        fFirmBusinessPhone.Text = "303.988.6286"
        fFirmBusinessPhoneExt.Text = ""
        fFirmCellPhone.Text = ""
        fFirmFax.Text = "303.986.2771"
        sTemp = sTemp & fFirmBusinessPhone.Text & "  Fax " & fFirmFax.Text & vbCrLf
    ...
    With Me
        ...
        f33_cTotalAdjustingFee = Format(GetProperty("f33_cTotalAdjustingFee"), "$#,###,###,##0.00")
        f33_cTotalAdjustingFee_Supplement = f33_cTotalAdjustingFee
        If .f14aSupplement = "0" Then
            .f14aSupplement = vbNullString
            chkSupplementNo.Value = True
            chkSupplementYes.Value = False
            f16NetClaim.Visible = True
            f16NetClaim_Supplement.Visible = False
            f33_cTotalAdjustingFee.Visible = True
            f33_cTotalAdjustingFee_Supplement.Visible = False
        Else
            chkSupplementNo.Value = False
            chkSupplementYes.Value = True
            f16NetClaim.Visible = False
            f16NetClaim_Supplement.Visible = True
            f33_cTotalAdjustingFee.Visible = False
            f33_cTotalAdjustingFee_Supplement.Visible = True
        End If
        .f14bRebilled = GetProperty("f14b_sRebilled")
        If .f14bRebilled = "0" Then
            .f14bRebilled = vbNullString
            chkReopenNo.Value = True
            chkReopenYes.Value = False
            
        Else
            chkReopenNo.Value = False
            chkReopenYes.Value = True
        End If
        ...
        .f16NetClaim_Supplement = .f16NetClaim
