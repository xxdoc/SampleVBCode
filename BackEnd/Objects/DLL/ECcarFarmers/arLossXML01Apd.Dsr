...
Private msubVehicleDetails As arsubLossXML01VehicleDetails   ' Loss Details
...
Private Sub ActiveReport_ReportEnd()
    ...
    Unload subLossXML01VehicleDetails
    Set subLossXML01VehicleDetails.object = Nothing
    ...
    Set msubVehicleDetails = Nothing
...
Private Sub ActiveReport_ReportStart()
    ...
    Set msubVehicleDetails = New arsubLossXML01VehicleDetails
    ...
    msubCOV.DedType = "Auto"
    
    Set msubAssDetails.AssDetailRS = mXML01LossReport.XML01Loss.AssignmentDetailRS
    Set msubVehicleDetails.VehicleDetailRS = mXML01LossReport.XML01Loss.VehicleDetailRS
    ...
    subLossXML01VehicleDetails.object = msubVehicleDetails.object
...
Private Sub Detail_Format()
    ...
    subLossXML01VehicleDetails.Visible = True
    ...
    With mXML01LossReport.XML01Loss
        ...
        ' Auto Differs from Property
        PolicyDetail.PolicyEdition = IIf(IsNull(.PolicyDetailRS.getField(1, "PolicyEdition")), vbNullString, .PolicyDetailRS.getField(1, "PolicyEdition"))
        PolicyDetail.LienHolderName = IIf(IsNull(.PolicyDetailRS.getField(1, "LienHolderName")), vbNullString, .PolicyDetailRS.getField(1, "LienHolderName"))
        PolicyDetail.LienHolderAddress = IIf(IsNull(.PolicyDetailRS.getField(1, "LienHolderAddress")), vbNullString, .PolicyDetailRS.getField(1, "LienHolderAddress"))
        ...
        f_PolicyEdition.Text = PolicyDetail.PolicyEdition
        f_LienHolderName.Text = PolicyDetail.LienHolderName
        f_LienHolderAddress.Text = PolicyDetail.LienHolderAddress
