VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} arRptIBFarmers02 
   Caption         =   "IB"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arRptIBFarmers02.dsx":0000
End
Attribute VB_Name = "arRptIBFarmers02"
...
Public Function GetXMLExport() As String
    ...
    Dim oFeeBillPaymentRS As WDDXRecordset
    Dim lCount As Long
    ...
    '6.15.2005 BGS Need to Add FeeBillPaymentRS to the Wddx so
    'It can be harvested when sending Documents to Farmers
'var name="FeeBillPaymentRS">
'- <recordset rowCount="1" fieldNames="BillID,PayeeTIN,PayeeZip,PaymentAmount">

    Set oFeeBillPaymentRS = New WDDXRecordset
    oFeeBillPaymentRS.addColumn "BillID"
    oFeeBillPaymentRS.addColumn "PayeeTIN"
    oFeeBillPaymentRS.addColumn "PayeeZip"
    oFeeBillPaymentRS.addColumn "PaymentAmount"
    oFeeBillPaymentRS.addRows 1
    '******************This Field Has been changed 9.19.2005
'    oFeeBillPaymentRS.setField 1, "BillID", "[ENTER_BillID]"
    sTemp = oMyRS.getField(1, "f02_sIBNumber")
    oFeeBillPaymentRS.setField 1, "BillID", CleanXML(sTemp)
    '******************This Field Has been changed 9.19.2005
    oFeeBillPaymentRS.setField 1, "PayeeTIN", "841258811"
    oFeeBillPaymentRS.setField 1, "PayeeZip", "80235"
    sTemp = oMyRS.getField(1, "f33_cTotalAdjustingFee")
    sTemp = Format(sTemp, "0.00")
    oFeeBillPaymentRS.setField 1, "PaymentAmount", CleanXML(sTemp)
    ...
    End If
    oMyStruct.setProp "FeeBillPaymentRS", oFeeBillPaymentRS
