VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} arsubLossCCMSplhCont 
   Caption         =   "CCMS Loss sub PLHCont Report"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arsubLossCCMSplhCont.dsx":0000
End
Attribute VB_Name = "arsubLossCCMSplhCont"
...
Private Sub Detail_Format()
    On Error GoTo EH
    Dim PLHCont As udtPriorLossHistCont
    Dim lErrNum As Long
    Dim sErrDesc As String
