VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} arRCA 
   Caption         =   "RCA"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arRCA.dsx":0000
End
Attribute VB_Name = "arRCA"
...
Private Sub ActiveReport_ReportStart()
    ...
    With Me
        .f_p001_sStateFarmInsExchange.Text = IIf(CBool(GetProperty("f_p001_sStateFarmInsExchange")), "X", "")
        .f_p002_sFireInsuranceExchange.Text = IIf(CBool(GetProperty("f_p002_sFireInsuranceExchange")), "X", "")
        .f_p003_sTruckInsExchange.Text = IIf(CBool(GetProperty("f_p003_sTruckInsExchange")), "X", "")
        .f_p004_sMidCenturyInsCompany.Text = IIf(CBool(GetProperty("f_p004_sMidCenturyInsCompany")), "X", "")
        .f_p005_Other.Text = IIf(CBool(GetProperty("f_p005_Other")), "X", "")
        .f_p006_RCAOther.Text = GetProperty("f_p006_RCAOther")
        ...
        .f_p007_TypeOfPropertyInvolved.Text = GetProperty("f_p007_TypeOfPropertyInvolved")
        ...
        If GetProperty("f_p008_Line10WithinDays") <> NULL_DATE Then
            .f_p008_Line10WithinDays.Text = Format(GetProperty("f_p008_Line10WithinDays"), "mm/dd/yy")
        Else
            .f_p008_Line10WithinDays.Text = vbNullString
        End If
