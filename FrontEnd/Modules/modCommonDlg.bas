...
Public Function ShowOpen(ByVal hWnd As Long, Optional ByVal centerForm As Boolean = True) As SelectedFile
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Public Function ShowOpen" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
...
Public Function ShowSave(ByVal hWnd As Long, Optional ByVal centerForm As Boolean = True) As SelectedFile
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Public Function ShowSave" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
...
Public Function ShowColor(ByVal hWnd As Long, Optional ByVal centerForm As Boolean = True) As SelectedColor
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Public Function ShowColor" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
...
Public Function ShowFont(ByVal hWnd As Long, ByVal startingFontName As String, Optional ByVal centerForm As Boolean = True) As SelectedFont
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Public Function ShowFont" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
Public Function ShowPrinter(ByVal hWnd As Long, Optional ByVal centerForm As Boolean = True) As Long
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Public Function ShowPrinter" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
...
'        Debug.Print "MsgBox " & (rectMsg.Right - rectMsg.left) / 2
    ...
    Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Private Function WinProcCenterScreen" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
...
Private Function WinProcCenterForm(ByVal lMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    If lMsg = HCBT_ACTIVATE Then
     ...
     Exit Function
EH:
    Err.Raise Err.Number, , App.EXEName & vbCrLf & msClassName & vbCrLf & "Private Function WinProcCenterForm" & vbCrLf & "Error # " & Err.Number & vbCrLf & Err.Description & vbCrLf
End Function
