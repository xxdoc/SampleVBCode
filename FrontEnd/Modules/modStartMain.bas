...
Public gfrmECTray As frmECTray
Public gfrmWallPaper As frmWallPaper
...
Public Sub Main()
    ...
    If App.PrevInstance Then
        ...
        SaveSetting App.EXEName, "MSG", "COMMAND", "SHOW_ALL"
        End
        Exit Sub
    End If
    ...
    'Save the Appexe name
    SaveSetting "ECS", "WEB_SECURITY", "MAIN_APP_EXE_NAME", App.EXEName
    goUtil.gsMainAppEXEName = App.EXEName
    'This Car Prefix Will tell us which company the Carrier belongs to.
    'So Far ONLY Eberls ... EC in V2ECcar
    ...
    Set gfrmECTray = New frmECTray
    Set gfrmWallPaper = New frmWallPaper
    
    Set goUtil.gfrmWallPaper = gfrmWallPaper
    Load gfrmWallPaper
    
    Set goUtil.gfrmCommStatus = gfrmCommStatus
    
    Set goUtil.gfrmECTray = gfrmECTray
